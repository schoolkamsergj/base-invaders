...
(function (global) {
    ...
    enFallback = {
        ...
        "shopItems": {
            ...
            "extraLifeLightning": { "name": "Extra Life (⚡)", "stats": "+1 continue (pay with lightning)" },
            "shieldLightning": { "name": "Shield Charge (⚡)", "stats": "Absorbs 5 hits (pay with lightning)" },
    ...
    var ruFallback = {
        ...
        shopItems: {
            ...
            extraLifeLightning: { name: "Доп. жизнь (⚡)", stats: "+1 продолжение за молнии" },
            shieldLightning: { name: "Заряд щита (⚡)", stats: "Поглощает 5 ударов за молнии" },
    ...
    var ukFallback = {
        ...
        shopItems: {
            ...
            extraLifeLightning: { name: "Додаткове життя (⚡)", stats: "+1 продовження за блискавки" },
            shieldLightning: { name: "Заряд щита (⚡)", stats: "Поглинає 5 ударів за блискавки" },
