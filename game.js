...
class MenuScene extends Phaser.Scene {
    ...
    showLanguageOverlay() {
        ...
        var textStyle = { fontSize: '17px', fontFamily: 'Arial, sans-serif', color: '#ffffff', align: 'center' };
        this.langEn = this.add.text(width / 2, centerY - rowH * 4, enStr, textStyle);
        ...
        this.langHi = this.add.text(width / 2, centerY - rowH * 3, hiStr, textStyle);
        ...
        this.langRu = this.add.text(width / 2, centerY - rowH * 2, ruStr, textStyle);
        ...
        this.langTg = this.add.text(width / 2, centerY, tgStr, textStyle);
        ...
        this.langId = this.add.text(width / 2, centerY + rowH, idStr, textStyle);
        ...
        this.langVi = this.add.text(width / 2, centerY + rowH * 2, viStr, textStyle);
        ...
        this.langPt = this.add.text(width / 2, centerY + rowH * 3, ptStr, textStyle);
        ...
        this.langFr = this.add.text(width / 2, centerY + rowH * 4, frStr, textStyle);
    ...
    closeLanguageOverlay() {
        const el = [this.langOverlay, this.langPanel, this.langPanelBorder, this.langTitle, this.langEn, this.langHi, this.langRu, this.langUk, this.langTg, this.langId, this.langVi, this.langPt, this.langFr];
        el.forEach(o => { if (o && o.destroy) o.destroy(); });
        this.langOverlay = this.langPanel = this.langPanelBorder = this.langTitle = this.langEn = this.langHi = this.langRu = this.langUk = this.langTg = this.langId = this.langVi = this.langPt = this.langFr = null;
    }
}
